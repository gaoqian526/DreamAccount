package com.gao.dreamaccount.views.ldialogs;
...
public class CustomListDialog extends BaseDialog {
    ...
    private CustomListDialog(Builder _builder) {
        ...
        this.mTypeface = _builder.mTypeface == null ? Typeface.createFromAsset(getContext().getResources().getAssets(), "fonts/Roboto-Medium.ttf") : _builder.mTypeface;
